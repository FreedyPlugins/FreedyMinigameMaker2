        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (imageFrame == null) {
                    ...
                    EntityItemFrame frame = new EntityItemFrame(EntityTypes.ITEM_FRAME, worldServer);
    ...
    public void applyMapToAllPlayer(Image image) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                PacketPlayOutSpawnEntity spawnEntityPacket = new PacketPlayOutSpawnEntity(frame, EntityTypes.ITEM_FRAME, frame.getDirection().get2DRotationValue(), frame.getBlockPosition());
                ...
                PacketPlayOutMap mapPacket = new PacketPlayOutMap(mapId, (byte) 3, false, false, emptyList(), imageFrame.getPixels(), 0, 0, 128, 128);
